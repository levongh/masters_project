...
#include "include_files/graph/graph.hpp"
#include "include_files/graph/multicut/kernighan-lin.hpp"
...
void testMulticut() {
    ...
    graph::multicut::kernighanLin(graph, weights, edge_labels, edge_labels);
...
void testIterators() {
    ...
    {
        graph::Graph<>::VertexIterator it = g.verticesFromVertexBegin(0);
        test(*it == 1);
        test(it[0] == 1);
        test(it[1] == 3);
        ++it;
    ...
    {
        graph::Graph<>::VertexIterator it = g.verticesToVertexBegin(0);
        test(*it == 1);
        test(it[0] == 1);
        test(it[1] == 3);
        ++it;
    ...
    {
        graph::Graph<>::EdgeIterator it = g.edgesFromVertexBegin(0);
        test(*it == 0);
        test(it[0] == 0);
        test(it[1] == 3);
        ++it;
    ...
    {
        graph::Graph<>::EdgeIterator it = g.edgesToVertexBegin(0);
        test(*it == 0);
        test(it[0] == 0);
        test(it[1] == 3);
        ++it;
    ...
    {
        graph::Graph<>::AdjacencyIterator it = g.adjacenciesFromVertexBegin(0);
        test(it->vertex() == 1);
        test(it[0].vertex() == 1);
        test(it[1].vertex() == 3);
        ++it;
    ...
    {
        graph::Graph<>::AdjacencyIterator it = g.adjacenciesToVertexBegin(0);
        test(it->vertex() == 1);
        test(it[0].vertex() == 1);
        test(it[1].vertex() == 3);
        ++it;
